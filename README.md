# analyze-desumasu-dearu [![Actions Status: test](https://github.com/azu/analyze-desumasu-dearu/workflows/test/badge.svg)](https://github.com/azu/analyze-desumasu-dearu/actions?query=workflow%3A"test")
